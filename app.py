...
# === Load model ===
open("/Users/arpit/Downloads/forecasting_ev_model.pkl")
model = joblib.load("/Users/arpit/Downloads/forecasting_ev_model.pkl")
...
# Image
st.image("/Users/arpit/Downloads/ev-car-factory.jpg", use_container_width=True)
...
@st.cache_data
def load_data():
    df = pd.read_csv("/Users/arpit/Downloads/preprocessed_ev_data.csv")
